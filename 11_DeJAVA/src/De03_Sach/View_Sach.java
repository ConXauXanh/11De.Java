...
public class View_Sach extends javax.swing.JFrame {
    ...
    void fillTable(ArrayList<Model_Sach> list) {
        mol = (DefaultTableModel) tblSach.getModel();
        mol.setRowCount(0);
        for (Model_Sach x : list) {
    ...
    public View_Sach() {
        ...
        cboSoTrang.removeAllItems();
        for (int i = 10; i <= 1000; i++) {
            cboSoTrang.addItem(String.valueOf(i));
        }
        this.fillTable(rp.getAll());
        i = rp.getAll().size();
        showData(i - 1);
        tblSach.setRowSelectionInterval(i - 1, i - 1);
    }
    ...
    private void initComponents() {
        ...
        cboSoTrang = new javax.swing.JComboBox<>();
        ...
        cboSoTrang.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(cboSoTrang, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(54, 54, 54)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(btnXoa)
        ...
        if (chon == 0) {
            if (i == -1) {
                ...
                if (this.readForm() != null) {
                    String ma = tblSach.getValueAt(i, 0).toString();
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (chon == 0) {
            if (i == -1) {
                ...
                if (this.readForm() != null) {
                    String maCanXoa = tblSach.getValueAt(i, 0).toString();
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
        ...
        if (chon == 0) {
            String tenCanTim = JOptionPane.showInputDialog(this, "Nhap ten can tim");
    ...
    private javax.swing.JComboBox<String> cboSoTrang;
...
void showData(int i) {
        txtMa.setText(tblSach.getValueAt(i, 0).toString());
        txtTen.setText(tblSach.getValueAt(i, 1).toString());
        cboSoTrang.setSelectedItem(tblSach.getValueAt(i, 2).toString());
        if (tblSach.getValueAt(i, 3).toString().equalsIgnoreCase("Mới")) {
            rdoMoi.setSelected(true);
        } else {
    ...
    Model_Sach readForm() {
        ...
        sotrang = Integer.parseInt(cboSoTrang.getSelectedItem().toString());
        if (rdoMoi.isSelected()) {
            trangthai = 1;
        } else {
            trangthai = 0;
        }
        return new Model_Sach(ma, ten, sotrang, trangthai);
    }
}
